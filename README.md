...
1. Host creates room  
2. Second player joins via room code  
3. Server starts match automatically  
4. Current player fires striker  
5. Backend validates shot & turn  
6. Board sync updates opponent  
7. Server calculates scores & next turn  
8. Winner declared after reaching score limit or board clear  
...
💻 **GitHub Repository**  
https://github.com/NikhilChaudhary285/Multiplayer-Carrom-Game
